...
<body>
	<div id="wrapper">
		...
		<main id="main">
			...
			<ul>
    <?php
    if(isset($_SESSION["taskname"]) && isset($_SESSION["pagename"]) && is_array($_SESSION["pagename"])) {
        foreach ($_SESSION["pagename"] as $key => $value) { ?>
            <li><a href='<?php echo $_SESSION["taskname"].'/'.$value.'.php'?>'><?php echo $_SESSION["taskname"].'/'.$value.'.php'?></a></li>
        <?php }
    } else {
