...
function initIsotopeFilter(){
	...
	jQuery('.isotope-filter').each(function() {
		...
		filterLinks.click(function(e) {
			var link = jQuery(this), selectedFilter = link.attr('rel');
...
function initHeaderClone() {
	jQuery(document).ready(function(){   
	    var scroll = jQuery(window).scrollTop();
	     jQuery("#header").clone().addClass('clone').appendTo('#wrapper .wrap-inner');
...
function initHeaderFixed() {
	jQuery(window).scroll(function() {    
	    ...
	    if (scroll >= header) {
	        ...
	        jQuery(".stickynav").addClass("fixed");
	    }
		else if (scroll <= header) {
	       jQuery(".header.clone").removeClass("fixed");
	       jQuery(".stickynav").removeClass("fixed");
	    }
	});
}
	...
	$(document).ready(function(){   
	    $(function() {
		  ...
		  $(document).on("click", function(e) {
		    if ($(e.target).is(".search-form .input, .search-form a") === false) {
